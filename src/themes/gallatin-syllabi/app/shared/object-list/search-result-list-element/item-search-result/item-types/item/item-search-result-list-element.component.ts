...
@listableObjectComponent('PublicationSearchResult', ViewMode.ListElement, Context.Any, 'gallatin-sylabi')
@listableObjectComponent(ItemSearchResult, ViewMode.ListElement, Context.Any, 'gallatin-syllabi')
@Component({
